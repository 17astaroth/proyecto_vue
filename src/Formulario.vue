<template>
        ...
        <div class="row">
            <div class="col m12 card-panel">
                <form @submit.prevent="agregarUsuario">
                    ...
                    <div class="row">
                        <form @submit.prevent="agregarLugar">
                            <div class="col m4 card-panel">
                                <label>Ingrese los lugares que visita a diario en los que es consciente de que consume
                                    agua</label>
                    ...
                    <div class="row">
                        <div class="col m4">
                            <label><input type="checkbox" v-model="confirmacion"><span>Conscientemente ¿sientes que en tu
                                    día a día
                    ...
                    <div class="row">
                        <button type="submit" class="btn indigo darken-4">ENVIAR <i
                ...
                <table class="table bordered striped">
                    ...
                    <tbody>
                        <tr v-for="usuario in usuarios" v-bind:key="usuario">
                            ...
                            <td><label><input type="checkbox" disabled v-model="usuario.confirmacion"><span></span></label>
                            </td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div>
        <button type="button" class="btn indigo darken-4"><router-link to="/detail">RECOMENDACIONESSS</router-link><i
